namespace HW2.Tests
{
    ...
    public class DistinctNumberCounterTests
    {
        ...
        [TestCase(ExpectedResult = "0")] // Testing an empty list.
        [TestCase(0, ExpectedResult = "1")] // Testing a list with one item.
        [TestCase(0, 1, ExpectedResult = "2")] // Testing a list with two items.
